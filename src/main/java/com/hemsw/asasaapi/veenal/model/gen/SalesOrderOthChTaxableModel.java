...
@Entity
@Table(name = "sales_order_oth_charge_taxable")
public class SalesOrderOthChTaxableModel
{
	...
	public SalesOrderOthChTaxableModel()
	{
	}

	public SalesOrderOthChTaxableModel(EstimateOthChTaxableModel estimateOthChTaxableModel)
	{
	...
	public SalesOrderOthChTaxableModel(PiOthChTaxableModel piOthChTaxableModel)
	{
