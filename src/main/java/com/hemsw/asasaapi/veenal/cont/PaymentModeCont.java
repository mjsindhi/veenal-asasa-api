...
import com.hemsw.asasaapi.veenal.service.gen.PaymentModeSer;
...
public class PaymentModeCont
{
	...
	public ResponseEntity create(@RequestBody PaymentModeReqDto paymentModeReqDto)
	{
		...
		CommonUpsertResDto commonUpsertResDto = paymentModeSer.create(paymentModeReqDto, userModel);
	...
	)
	{
		...
		commonGetResDto = paymentModeSer.getLdtos(name);
