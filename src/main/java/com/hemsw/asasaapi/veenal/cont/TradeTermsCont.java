...
import com.hemsw.asasaapi.veenal.service.gen.TradeTermsSer;
...
@RestController
public class TradeTermsCont
{

	@Autowired
	TradeTermsSer tradeTermsSer;

	@PostMapping("/trade-terms")
	public ResponseEntity create(@RequestBody TradeTermsReqDto tradeTermsReqDto)
	{

		UserDetailsImpl userDetailsImpl = (UserDetailsImpl) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
		UserModel userModel = userDetailsImpl.getUserModel();

		CommonUpsertResDto commonUpsertResDto = tradeTermsSer.create(tradeTermsReqDto, userModel);
	...
	@GetMapping("/trade-terms")
	public ResponseEntity getTradeTerms(
			@RequestParam(required = false) String name
	)
	{
		CommonGetResDto commonGetResDto = null;

		commonGetResDto = tradeTermsSer.getLdtos(name);
