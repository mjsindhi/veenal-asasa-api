...
import com.hemsw.asasaapi.veenal.service.gen.CountrySer;
...
public class CountryCont
{
	...
	public ResponseEntity create(@RequestBody CountryReqDto countryReqDto)
	{

		UserDetailsImpl userDetailsImpl = (UserDetailsImpl) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
		UserModel userModel = userDetailsImpl.getUserModel();

		CommonUpsertResDto commonUpsertResDto = countrySer.create(countryReqDto, userModel);
	...
	)
	{
		...
		commonGetResDto = countrySer.getLdtos(name);
