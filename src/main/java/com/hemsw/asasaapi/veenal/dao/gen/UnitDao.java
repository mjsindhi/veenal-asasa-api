...
public class UnitDao
{
	...
	{
		String sql = String.format(DaoHelper.SELECT_BY_ID_SQL, TableName.UNIT, String.valueOf(id));
		List<UnitModel> dtos = session.createNativeQuery(sql, UnitModel.class).getResultList();
