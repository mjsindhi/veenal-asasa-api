...
public enum RptSalesByCustomerSortByEnum
{
	...
	RptSalesByCustomerSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesByCustomerSortByEnum getByName(String name)
	{
		for (RptSalesByCustomerSortByEnum value : values())
		{
