...
public enum RptSalesByAgentSortByEnum
{
	...
	RptSalesByAgentSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesByAgentSortByEnum getByName(String name)
	{
		for (RptSalesByAgentSortByEnum value : values())
		{
