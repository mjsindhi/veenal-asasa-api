...
public enum RptPurchaseBySupplierSortByEnum
{
	...
	RptPurchaseBySupplierSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseBySupplierSortByEnum getByName(String name)
	{
		for (RptPurchaseBySupplierSortByEnum value : values())
		{
