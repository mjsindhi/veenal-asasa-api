...
public enum RptSalesByProdCatSortByEnum
{
	...
	RptSalesByProdCatSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesByProdCatSortByEnum getByName(String name)
	{
		for (RptSalesByProdCatSortByEnum value : values())
		{
