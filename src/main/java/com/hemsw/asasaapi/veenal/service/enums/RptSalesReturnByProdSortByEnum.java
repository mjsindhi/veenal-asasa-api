...
public enum RptSalesReturnByProdSortByEnum
{
	...
	RptSalesReturnByProdSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByProdSortByEnum getByName(String name)
	{
		for (RptSalesReturnByProdSortByEnum value : values())
		{
