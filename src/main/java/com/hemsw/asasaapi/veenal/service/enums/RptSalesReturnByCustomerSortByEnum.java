...
public enum RptSalesReturnByCustomerSortByEnum
{
	...
	RptSalesReturnByCustomerSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByCustomerSortByEnum getByName(String name)
	{
		for (RptSalesReturnByCustomerSortByEnum value : values())
		{
