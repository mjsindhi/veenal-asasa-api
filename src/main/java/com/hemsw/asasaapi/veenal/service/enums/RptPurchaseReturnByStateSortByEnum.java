...
public enum RptPurchaseReturnByStateSortByEnum
{
	NAME("state_name", "State Name"),
	...
	RptPurchaseReturnByStateSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseReturnByStateSortByEnum getByName(String name)
	{
		for (RptPurchaseReturnByStateSortByEnum value : values())
		{
