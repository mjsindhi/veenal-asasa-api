...
public enum RptPurchaseByProdCatSortByEnum
{
	...
	RptPurchaseByProdCatSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseByProdCatSortByEnum getByName(String name)
	{
		for (RptPurchaseByProdCatSortByEnum value : values())
		{
