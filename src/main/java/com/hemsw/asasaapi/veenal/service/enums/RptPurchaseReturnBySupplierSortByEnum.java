...
public enum RptPurchaseReturnBySupplierSortByEnum
{
	...
	RptPurchaseReturnBySupplierSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseReturnBySupplierSortByEnum getByName(String name)
	{
		for (RptPurchaseReturnBySupplierSortByEnum value : values())
		{
