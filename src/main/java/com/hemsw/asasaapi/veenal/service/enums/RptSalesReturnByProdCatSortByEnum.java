...
public enum RptSalesReturnByProdCatSortByEnum
{
	...
	RptSalesReturnByProdCatSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByProdCatSortByEnum getByName(String name)
	{
		for (RptSalesReturnByProdCatSortByEnum value : values())
		{
