...
public enum RptPurchaseByProdSortByEnum
{
	...
	RptPurchaseByProdSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseByProdSortByEnum getByName(String name)
	{
		for (RptPurchaseByProdSortByEnum value : values())
		{
