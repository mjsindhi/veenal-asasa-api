...
public enum RptSalesReturnByStateSortByEnum
{
	...
	RptSalesReturnByStateSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByStateSortByEnum getByName(String name)
	{
		for (RptSalesReturnByStateSortByEnum value : values())
		{
