...
public enum RptSalesReturnByDaySortByEnum
{
	DATE("date", "Date"),
	...
	RptSalesReturnByDaySortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByDaySortByEnum getByName(String name)
	{
		for (RptSalesReturnByDaySortByEnum value : values())
		{
