...
public enum RptPurchaseReturnByCitySortByEnum
{
	CITY("city", "City"),
	...
	RptPurchaseReturnByCitySortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseReturnByCitySortByEnum getByName(String name)
	{
		for (RptPurchaseReturnByCitySortByEnum value : values())
		{
