...
public enum RptSalesByCitySortByEnum
{
	CITY("city", "City"),
	...
	RptSalesByCitySortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesByCitySortByEnum getByName(String name)
	{
		for (RptSalesByCitySortByEnum value : values())
		{
