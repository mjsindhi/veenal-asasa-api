...
public enum RptSalesReturnByAgentSortByEnum
{
	...
	RptSalesReturnByAgentSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByAgentSortByEnum getByName(String name)
	{
		for (RptSalesReturnByAgentSortByEnum value : values())
		{
