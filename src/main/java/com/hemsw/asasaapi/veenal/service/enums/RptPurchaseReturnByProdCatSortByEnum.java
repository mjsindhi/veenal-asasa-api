...
public enum RptPurchaseReturnByProdCatSortByEnum
{
	NAME("prod_cat_name", "Product Category Name"),
	...
	RptPurchaseReturnByProdCatSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseReturnByProdCatSortByEnum getByName(String name)
	{
		for (RptPurchaseReturnByProdCatSortByEnum value : values())
		{
