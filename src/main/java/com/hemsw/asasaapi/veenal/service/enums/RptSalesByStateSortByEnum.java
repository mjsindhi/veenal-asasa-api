...
public enum RptSalesByStateSortByEnum
{
	...
	RptSalesByStateSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesByStateSortByEnum getByName(String name)
	{
		for (RptSalesByStateSortByEnum value : values())
		{
