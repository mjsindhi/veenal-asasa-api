...
public enum RptSalesByProdSortByEnum
{
	...
	RptSalesByProdSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesByProdSortByEnum getByName(String name)
	{
		for (RptSalesByProdSortByEnum value : values())
		{
