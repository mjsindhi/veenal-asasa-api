...
public enum RptPurchaseByStateSortByEnum
{
	...
	RptPurchaseByStateSortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseByStateSortByEnum getByName(String name)
	{
		for (RptPurchaseByStateSortByEnum value : values())
		{
