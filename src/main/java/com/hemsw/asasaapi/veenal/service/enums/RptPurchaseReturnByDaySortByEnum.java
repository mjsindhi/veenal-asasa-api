...
public enum RptPurchaseReturnByDaySortByEnum
{
	DATE("date", "Date"),
	...
	RptPurchaseReturnByDaySortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseReturnByDaySortByEnum getByName(String name)
	{
		for (RptPurchaseReturnByDaySortByEnum value : values())
		{
