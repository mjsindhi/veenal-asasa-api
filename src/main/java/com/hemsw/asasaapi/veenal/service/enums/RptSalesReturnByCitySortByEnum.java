...
public enum RptSalesReturnByCitySortByEnum
{
	CITY("city", "City"),
	...
	RptSalesReturnByCitySortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptSalesReturnByCitySortByEnum getByName(String name)
	{
		for (RptSalesReturnByCitySortByEnum value : values())
		{
