...
public enum RptPurchaseByCitySortByEnum
{
	CITY("city", "City"),
	...
	RptPurchaseByCitySortByEnum(final String key, final String name)
	{
		this.key = key;
		this.name = name;
	}
	...
	public static RptPurchaseByCitySortByEnum getByName(String name)
	{
		for (RptPurchaseByCitySortByEnum value : values())
		{
